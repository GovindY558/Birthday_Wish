            ...
            <Card className="bg-card/80 backdrop-blur-sm">
                <CardContent className="p-8 md:p-12 space-y-8">
                    <div className="relative aspect-[2/1] w-full max-w-4xl mx-auto rounded-lg overflow-hidden shadow-lg">
                        <Image src="/frame.jpg" alt="A banner representing a story" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover" data-ai-hint="love story" />
                    </div>
                    <div className="font-body text-lg text-foreground/90 max-w-3xl mx-auto space-y-6 text-center">
                        ...
                        <p>You know, I really wished I could celebrate your birthday with you. I’m so sorry, my love, that I can’t be there right now. But if you close your eyes and feel with your heart, you’ll find me right there with you.<br /><br />Chalo ab Ankhe Band Karo, Aur Socho Mai Cake Leke Aaya Hun, Aur Ap Cake 🎂  Cut Kar Rahi Hooooo...</p>
                        <p>Thank you so, so much for coming into my life— मेरी ज़िंदगी.</p>
                        <p>#GKY ♥ </p>
                    </div>
                </CardContent>
            </Card>
