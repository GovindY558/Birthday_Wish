                                ...
                                <RevealCard coverContent={<p className="text-lg">A little something to help your inner artist shine...</p>}>
                                    <div className="flex flex-col items-center text-center">
                                        <div className="relative w-full max-w-lg">
                                            <Image src="/gifts/tripod.jpeg" alt="A creative gift" width={600} height={600} className="rounded-lg shadow-lg" data-ai-hint="camera accessory" />
                                        </div>
                                        <p className="mt-4 font-body text-lg max-w-prose">I know how much you love creating beautiful things & doing Photography. This is to help you capture every perfect angle. I can't wait to see what you create...!!</p>
                                    </div>
                                </RevealCard>
                            </CardContent>
                        </Card>
